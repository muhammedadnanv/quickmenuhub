...
const QRCodePage = () => {
  ...
  // Get the current URL for the menu
    ...
    if (svg) {
      ...
      img.onload = () => {
        ...
        if (ctx) {
          ...
          link.download = `${restaurantInfo.name.replace(/\s+/g, '-').toLowerCase()}-qr-code.png`;
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="mt-8 bg-muted rounded-xl p-6 animate-fade-in" style={{ animationDelay: "200ms" }}>
